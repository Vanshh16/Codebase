    ...
    <>
      <div className="relative flex justify-center items-center w-auto min-h-screen bg-gradient">
        ...
        <Image
              ...
              className="absolute mx-auto inset-0 w-[0%] h-auto md:w-full md:h-[40rem] opacity-10"
            />
          <div className="items-center grid grid-cols-2 md:flex md:flex-col lg:grid lg:grid-cols-2 lg:gap-10">
            ...
            <div className="mx-auto md:mt-40 lg:my-auto space-y-4">
              ...
              <div className="hidden md:block w-[12rem] h-16 md:w-[40rem] md:h-40 relative">
                {/* Gradients */}
              ...
              <p className="text-slate-100 md:tracking-widest font-normal italic text-sm md:text-lg mt-4 my-4 md:ml-28">
            ...
            <div className="flex justify-center items-center">
              <Image
                src={cb}
                alt="Codebase Logo"
                className="w-20 animation md:w-40 lg:w-96 h-auto z-20"
              />
            </div>
          </div>
          ...
          <div className="md:mt-80">
            <h2 className="md:text-5xl mr-auto text-2xl md:mb-10 md:tracking-widest font-semibold text-white">
              Gallery
            </h2>
            <Carousel />
          </div>
